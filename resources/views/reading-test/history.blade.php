...
@section('content-script')
    ...
    <script>
            ...
            tblAnswer = $("#tbl-answer").DataTable({
                ...
                columns: [{
                        ...
                        mRender: function(data, type, full) {
                            return `<a href="/lexile/admin/history/answere/${full.id}">
                                ${data}<br>
                    ...
                    },
                    {
                        ...
                        defaultContent: "--",
                        mRender: function(data,full,type) {
                            return `<a href="/lexile/admin/history/answere/${data}" class="btn btn-sm btn-primary btn-show"><i class="far fa-eye"></i></a>`
                        }
                    },
                ]
            });
        ...
        function exportExcel() {
            ...
            let subject = $('#subject').val();
            window.location.href = `/lexile/export-answer/${gradeId}/${subject}`;
            $('.row-table').LoadingOverlay("hide");
        }
    </script>
@endsection
